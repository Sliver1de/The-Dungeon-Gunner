...
public class MovementDetailsSO : ScriptableObject
{
    ...
    [Tooltip("The minimum move speed. The GetMoveSpeed method calculates a random value between minimum and maximum.")]
    ...
    [Tooltip("The maximum move speed. The GetMoveSpeed method calculates a random value between minimum and maximum.")]
    ...
    /// <summary>
    /// Get a random movement speed between the minimum and maximum values 在最小值和最大值之间获取随机运动速度
    /// </summary>
    /// <returns></returns>
